const CASES = [
  ...
  { id: 'classroom-ready-cohorts', client: 'Classroom Ready', year: '2025', headline: 'From 196 to 2,048 paying customers in six months — by reading the cohorts right', result: 'Paying customers grew from 196 to 2,048 within 6 months of launch — roughly 10x.', tags: ['EdTech', 'Data', 'Growth', 'Cohort Analysis'], discipline: 'Data' },
