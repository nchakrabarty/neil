const RECENT_ENGAGEMENTS = [
  'BC Pensions', 'Public Health Ontario', 'Care Team Technologies', 'Sound Transit', 'WorkBC',
  'Royal Bank of Canada', 'Dynamic Math', 'Motorola Mobility', 'Hubble Connected', 'NAQI Logix',
  'Argus Control Systems', 'Heart Water', 'eBay', 'Palo Alto Networks', 'RevenueWire',
];
  ...
  return (
    <>
      ...
      <Section>
        ...
        <p style={{
          marginTop: 'var(--space-8)', color: 'var(--text-secondary)', lineHeight: 1.9, letterSpacing: '0.01em',
        }}>
